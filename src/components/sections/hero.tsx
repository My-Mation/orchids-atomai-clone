  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div 
          className="absolute top-[20%] left-[20%] w-[400px] h-[400px] bg-blue-500/[0.02] rounded-full blur-[100px]" 
        />
        <div 
          className="absolute bottom-[20%] right-[20%] w-[400px] h-[400px] bg-purple-500/[0.02] rounded-full blur-[100px]" 
        />
      </motion.div>
      ...
      <div className="container max-w-[1200px] mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        <ScrollReveal variant="blur-in" delay={0.6} duration={1}>
          <p className="max-w-[700px] mb-12 text-[18px] md:text-[22px] font-light leading-[1.6] text-white/50">
            Advanced sensor fusion for early mechanical degradation detection. <br className="hidden md:block" />
        ...
        <ScrollReveal variant="blur-in" delay={0.8}>
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <a 
              ...
              className="group relative flex items-center justify-center gap-2 h-16 px-10 rounded-full bg-white text-black font-semibold text-[16px] transition-all duration-500 hover:scale-[1.05] active:scale-[0.98] hover:shadow-[0_0_40px_rgba(255,255,255,0.2)]"
            >
            ...
            <a 
              href="#success-story"
              className="text-white/60 hover:text-white font-medium transition-colors flex items-center gap-2 group h-16 px-6"
            >
